...
import { HomeIcon, TemplateIcon, BookmarkIcon, TruckIcon, MenuIcon, XIcon } from '@heroicons/react/solid';
...
const Header: NextPage = () =>{
    ...
    return (
        ...
        <header ref={ref} id="header" className={styles.header}>
            ...
            <motion.nav className={styles.header__nav} variants={NavVariants}
            initial="initial" animate={bar?'open':'close'}>
                        ...
                        animate={control}>
                            <Link href={item.href}>
                                <a aria-label={`enter para ir a ${item.title}`} style={{borderBottom: isRoute(item.href)}}>
                                    ...
                                    className={styles.information}>{item.title}</motion.span>
                        ...
                        animate={control}>
                            <Link href="/signup">
                                <a aria-label={`enter para ir a iniciar sesion`} style={{borderBottom: isRoute('signup')}}>
                                    ...
                                    className={styles.information}>Unete</motion.span>
                                    <Ripple color='blue'></Ripple>
                                </a>
                            </Link>
                    </motion.li>
